    ...
    <div>
        ...
        <div className='bg-pure-greys-5 text-richblack-700'>
            <div className='homepage_bg h-[320px]'>
                ...
                <div className='w-11/12 mx-auto max-w-maxContent flex flex-col items-center justify-between gap-8 my-20'>

                    {/* Button div */}
                    <div className='flex flex-row gap-7 text-white lg:my-20 translate-y-20'>
            ...
            <div className='mx-auto w-11/12 max-w-maxContent flex flex-col items-center justify-between gap-7'>
                ...
                <div className='flex flex-row items-between gap-7 mt-[100px] mb-10'>
        ...
        {/* Section 3 */}
        <div className='w-11/12 mx-auto my-20 max-w-maxContent flex-col items-center justify-between gap-8 first-letter bg-richblack-900 text-white'>
