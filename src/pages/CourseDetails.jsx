...
export const CourseDetails = () => {
    ...
    // fetch courseId from URL parameters
    ...
    useEffect( () => {
        const reviewCount = GetAverageRating(response?.data?.courseDetails?.ratingAndReviews)
    ...
    if(loading || !response) {
        return (
            <div className='flex min-h-[calc(100vh - 3.5rem)] items-center justify-center w-[100vw] h-[100vh]'>
