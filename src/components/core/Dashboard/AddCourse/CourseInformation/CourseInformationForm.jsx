...
export const CourseInformationForm = () => {
    ...
    useEffect( () => {
        const getCategories = async () => {
            ...
            try {
                ...
                console.log("Error in fetching categories in course information form....", error)
            }
    ...
    const onSubmit = async (data) => {
        ...
        // form data for addCourseDetails API
        const formData = new FormData()
    ...
    return (
        ...
        >   
            ...
            <div className='flex flex-col space-y-2'>
                ...
                {
                    errors.coursePrice && (
                        <span className='ml-2 tracking-wide text-xs text-pink-200'>
            ...
            <div className='flex flex-col space-y-2'>
                ...
                >
                    <option 
                        className='text-richblack-400 cursor-not-allowed' 
                        value="" 
                        disabled
                    >
                        Choose a Category
