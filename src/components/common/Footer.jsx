...
export const Footer = () => {
  return (
    <div className='bg-richblack-800'>
        ...
        <div className='w-11/12 max-w-maxContent text-richblack-400 flex lg:flex-row gap-8 items-center justify-between leading-6 mx-auto relative py-14'>
